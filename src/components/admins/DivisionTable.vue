    ...
    <template v-slot:top>
      ...
      >
        <v-toolbar-title class="text-uppercase primary--text">
            ...
            <span class="display-1"> Bidang</span>
        </v-toolbar-title>        
              ...
              <v-card-text>
                <v-container>
                  ...
                  <v-row>
                    ...
                    >
                      <v-autocomplete
                        v-model="selectedItem.fcompanyBean"
                        :items="itemsFCompany"
                        item-value="id"
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Nama Bidang', value: 'description' },
        { text: 'Dinas/Badan', value: 'fcompanyBean' },
      ...
      selectFCompany: {id: 0, kode1: '', description: 'AAAAA' },
      itemsFCompany: [
    ...
    methods: {
      ...
      deleteItemConfirm () {
        ...
        axios
          ...
          .delete( `${this.$store.getters.getApiBaseUrl}/deleteFDivision/${deletedItem.id}`)
          .then( response => {
              this.headerItems.splice(this.selectedItemIndex, 1)        
              this.closeDelete()
      ...
      save () {
        if (this.selectedItemIndex > -1) {
          ...
          axios({
                  method: 'put',
                  url: `${this.$store.getters.getApiBaseUrl}/updateFDivision/${this.selectedItem.id}`,
        ...
        this.closeForm()
          ...
          axios({
              method: 'post',
              url: `${this.$store.getters.getApiBaseUrl}/createFDivision`,
              data: this.selectedItem
          })
          .then(response => {
              this.isOperationSuccess = true
      ...
      lookupFCompany (fcompanyBean) {
        ...
        // console.log(fcompanyBean + " isi nya adalah " + str[0].description)
        
        // console.log(fcompanyBean)
        if (str.length>0){
    ...
    mounted(){      
      ...
      axios
        .get(`${this.$store.getters.getApiBaseUrl}/getAllFCompany`)
        .then(response => {
