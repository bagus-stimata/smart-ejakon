    ...
    <template v-slot:top>
      ...
      >
        <v-toolbar-title class="text-uppercase primary--text">
            ...
            <span class="display-1"> Dinas/Badan</span>
        </v-toolbar-title>        
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Nama Dinas', value: 'description' },
    ...
    methods: {
      ...
      deleteItemConfirm () {
        ...
        axios
          ...
          .delete( `${this.$store.getters.getApiBaseUrl}/deleteFCompany/${deletedItem.id}`)
          .then( response => {
              this.headerItems.splice(this.selectedItemIndex, 1)        
              this.closeDelete()
      ...
      save () {
        if (this.selectedItemIndex > -1) {
          ...
          axios({
                  method: 'put',
                  url: `${this.$store.getters.getApiBaseUrl}/updateFCompany/${this.selectedItem.id}`,
        ...
        this.closeForm()
          ...
          axios({
              method: 'post',
              url: `${this.$store.getters.getApiBaseUrl}/createFCompany`,
              data: this.selectedItem
          })
          .then(response => {
              this.isOperationSuccess = true
