    ...
    <template v-slot:top>
      ...
      >
        <v-toolbar-title class="text-uppercase primary--text">
            ...
            <span class="display-1"> IUJK</span>
        </v-toolbar-title>        
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'No PJT', value: 'no_pjt' },
        { text: 'No IUJK', value: 'no_iujk' },
        { text: 'Tanggal IUJK', value: 'tgl_iujk' },
        ...
        this.headerItems = [
          {
            id: 1,
            kode1: '0001',
            description: 'PT. APAKSINDO',
          },
          {
            id: 2,
            kode1: '0002',
            description: 'PT. MANDIRI',
          },
