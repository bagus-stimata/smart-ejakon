 ...
 -->
    ...
    <v-tabs-items v-model="myTabs2">
      <v-tab-item key="Multimedia">
        <PengawasanPhoGallery ref="refGalleryComponent" :parentItem="editedItem">

        </PengawasanPhoGallery>
      </v-tab-item>
      <v-tab-item key="Dokumen">
        <PengawasanPhoDocument ref="refDocumentComponent" :parentItem="editedItem">

        </PengawasanPhoDocument>
      </v-tab-item>
      <v-tab-item key="Info">
...
<script>
import PengawasanPhoGallery from './PengawasanPhoGallery'
import PengawasanPhoDocument from './PengawasanPhoDocument'
