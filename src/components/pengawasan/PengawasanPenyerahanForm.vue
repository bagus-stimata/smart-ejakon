...
<div>
  <v-card class="mt-4" 
  >
    <v-card-title> Hello {{ formTitle }}</v-card-title>
 ...
 -->
    ...
    <v-tabs-items v-model="myTabs2">
      <v-tab-item key="Multimedia">
        <PengawasanPenyerahanGallery ref="refGalleryComponent" :parentItem="editedItem">

        </PengawasanPenyerahanGallery>
      </v-tab-item>
      <v-tab-item key="Dokumen">
        <PengawasanPenyerahanDocument ref="refDocumentComponent" :parentItem="editedItem">

        </PengawasanPenyerahanDocument>
      </v-tab-item>
      <v-tab-item key="Info">
...
<script>
import PengawasanPenyerahanGallery from './PengawasanPenyerahanGallery'
import PengawasanPenyerahanDocument from './PengawasanPenyerahanDocument'
